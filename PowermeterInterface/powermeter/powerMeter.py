    ...
    def __init__(self, name=None, deviceName=None, samplingRate=None, measures=None,
        ...
        if measures is not None:
            ...
            if self.measurementInfo is None: 
                sys.exit("Powermeter cannot handle measurements: " + str(measures)) 
...
if __name__ == '__main__':
    ...
    def updatePlot():
        ...
        while not plotQueue.empty():
            ...
            # print(type(frame))
            print("Frame: ")
            print(frame)		# frame ist eindimensionaler array mit 20 (Samplingrate 1000), 40 (samplingrate 2000) einträgen
            # for i in frame:
            #    print(i[2])            # i[0] - voltage, i[1] - current, i[2] active power, i[3] reactive power
            plotQueue.task_done()
